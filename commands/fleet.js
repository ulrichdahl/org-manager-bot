...
class Command extends BaseCommand {
    ...
    constructor() {
        super();
        this.name = 'fleet';
        this.description = 'Manage your fleet. You can add, list and remove hangar packages (containing vehicles and ships).\n*Soon you will be able to sell the packages as well.*';
        this.usage = 'fleet add        Add a package of ships and vehicles to your fleet.\n'+
                     'fleet list       List your fleets packages, with the number for each package.\n'+
                     'fleet del [:num] Remove a package from your fleet. Use the list number to do it quickly.';
        ...
        this.conversations = {
            add: {
                ...
                confirm: {
                    question: 'Do you want to save this package (yes/no)?',
            ...
            del: {
                which: {
                    question: 'What package do you want to delete?',
                    answer: 'Package number',
                    help: 'The package you specify will be deleted immediately without further confirmation!',
                    next: '#save#'
                },
            }
        };
        ...
        try {
            ...
            if (e.state) {
                if (e.state === 'save') {
                    ...
                    console.log(data);
                    request.post('packages', data, d => {
                        message.reply('your package was succesfully saved!');
                    }, e => {
                        message.reply('an error occured while saving your package. I am very sorry but please try again later.');
                    });
                }
                else {
                    message.reply('i did not save your package. You can start over with "fleet add".');
                }
            }
        }
    }
